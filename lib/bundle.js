...
function render(data) {
  ...
  rootHeader.append("text").text("What's in your stack?").style("text-anchor", "middle");
  ...
  var circle = d3.selectAll(".parent").append("circle").attr("r", Math.floor(Math.random() * (60 - 80 + 1) + 80)).attr("opacity", 0.4)
  // .on("dblclick", d => toggleZoom(d))
