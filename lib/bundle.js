...
function render() {
  ...
  d3.json(jsonURL, function (data) {
    ...
    }).append("circle").attr("opacity", "0.5");

    var text = canvas.selectAll("text").data(nodes).enter();

    var enteringText = canvas.selectAll(".lang").append("text").style("text-anchor", "middle").text(function (d) {
      return d.data.name;
    });
